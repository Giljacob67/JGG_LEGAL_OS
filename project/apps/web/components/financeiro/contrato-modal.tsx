...
interface ContratoBody {
  ...
  processoId: string;
  tipo: string;
  valorFixo: string | number;
  percentual: string | number;
  taxaHora: string | number;
...
export function ContratoModal({
  ...
  const [form, setForm] = useState(() => {
    ...
    return { numero: "", clienteId: "", processoId: "", tipo: "fixo_mensal", valorFixo: "", percentual: "", taxaHora: "", horasMes: "", estimativa: "", vigente: true, dataInicio: "", dataFim: "", observacoes: "" };
  });
